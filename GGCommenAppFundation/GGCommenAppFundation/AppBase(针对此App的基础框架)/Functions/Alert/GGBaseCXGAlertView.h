...
typedef void(^GGBaseCXGAlertViewSubTitleTextViewConfigBlock)(QMUITextView *textView);
...
/// 只有标题+副标题+底部两个按钮(可以只设置一个按钮 title 传 nil 即可，点击左取消按钮自动隐藏 alertView / 点击右确认按钮不主动隐藏 alertView)
