...
@property(class, nonatomic, strong, readonly) UIFont *qd_titleTextFont;
@property(class, nonatomic, strong, readonly) UIFont *qd_boldTitleTextFont;
@property(class, nonatomic, strong, readonly) UIFont *qd_mainTextFont;
@property(class, nonatomic, strong, readonly) UIFont *qd_descriptionTextFont;
@property(class, nonatomic, strong, readonly) UIFont *qd_placeholderFont;
@property(class, nonatomic, strong, readonly) UIFont *qd_codeFont;
