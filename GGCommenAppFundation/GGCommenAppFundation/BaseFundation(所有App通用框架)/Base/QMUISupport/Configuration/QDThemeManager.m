...
@property(nonatomic, strong) UIFont *qd_titleTextFont;
@property(nonatomic, strong) UIFont *qd_boldTitleTextFont;
@property(nonatomic, strong) UIFont *qd_mainTextFont;
@property(nonatomic, strong) UIFont *qd_descriptionTextFont;
@property(nonatomic, strong) UIFont *qd_placeholderFont;
@property(nonatomic, strong) UIFont *qd_codeFont;
...
- (instancetype)init {
    if (self = [super init]) {
        ...
        self.qd_titleTextFont = UIFontMake(16.f);
        self.qd_boldTitleTextFont = UIFontBoldWithFont(self.qd_titleTextFont);
        self.qd_mainTextFont = UIFontMake(16.f);
        self.qd_descriptionTextFont = UIFontMake(12.f);
        self.qd_placeholderFont = self.qd_mainTextFont;
        self.qd_codeFont = self.qd_descriptionTextFont;
    }
    return self;
}
...
+ (UIFont *)qd_titleTextFont {
    return QDThemeManager.sharedInstance.qd_titleTextFont;
}

+ (UIFont *)qd_boldTitleTextFont {
    return QDThemeManager.sharedInstance.qd_boldTitleTextFont;
}

+ (UIFont *)qd_mainTextFont {
    return QDThemeManager.sharedInstance.qd_mainTextFont;
}

+ (UIFont *)qd_descriptionTextFont {
    return QDThemeManager.sharedInstance.qd_descriptionTextFont;
}

+ (UIFont *)qd_placeholderFont {
    return QDThemeManager.sharedInstance.qd_placeholderFont;
}

+ (UIFont *)qd_codeFont {
    return QDThemeManager.sharedInstance.qd_codeFont;
}
