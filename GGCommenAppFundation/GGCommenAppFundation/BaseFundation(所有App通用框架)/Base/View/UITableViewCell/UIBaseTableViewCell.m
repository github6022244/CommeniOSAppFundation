...
- (void)updateCellAppearanceWithIndexPath:(NSIndexPath *)indexPath {
    ...
    if ((cellPosition & QMUITableViewCellPositionFirstInSection) == QMUITableViewCellPositionFirstInSection) {
    ...
    } else if ((cellPosition & QMUITableViewCellPositionSingleInSection) == QMUITableViewCellPositionSingleInSection) {
