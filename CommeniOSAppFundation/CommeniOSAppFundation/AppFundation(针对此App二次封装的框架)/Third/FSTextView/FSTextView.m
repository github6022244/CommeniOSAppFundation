...
- (instancetype)initWithPlaceholderInset:(UIEdgeInsets)placeholderInset {
    if (self = [super initWithFrame:CGRectZero]) {
        _placeholderContainerInset = placeholderInset;
        [self initialize];
    }
    return self;
}
...
- (void)initialize {
    ...
    BOOL isNotSetPlaceholderEdgeInset = UIEdgeInsetsEqualToEdgeInsets(UIEdgeInsetsZero, _placeholderContainerInset);
    ...
    [self addConstraint:[NSLayoutConstraint constraintWithItem:placeholderLabel
                                                     ...
                                                     attribute:NSLayoutAttributeTop
                                                    multiplier:1.0
                                                      constant:isNotSetPlaceholderEdgeInset ? kFSTextViewPlaceholderVerticalMargin : _placeholderContainerInset.top]];
    [self addConstraint:[NSLayoutConstraint constraintWithItem:placeholderLabel
                                                     ...
                                                     attribute:NSLayoutAttributeLeft
                                                    multiplier:1.0
                                                      constant: isNotSetPlaceholderEdgeInset ? kFSTextViewPlaceholderHorizontalMargin : _placeholderContainerInset.left + 3]];
    [self addConstraint:[NSLayoutConstraint constraintWithItem:placeholderLabel
                                                     ...
                                                     attribute:NSLayoutAttributeWidth
                                                    multiplier:1.0
                                                      constant: isNotSetPlaceholderEdgeInset ? -kFSTextViewPlaceholderHorizontalMargin*2 : (_placeholderContainerInset.left + _placeholderContainerInset.right)]];
    [self addConstraint:[NSLayoutConstraint constraintWithItem:placeholderLabel
                                                     ...
                                                     attribute:NSLayoutAttributeHeight
                                                    multiplier:1.0
                                                      constant:isNotSetPlaceholderEdgeInset ? -kFSTextViewPlaceholderVerticalMargin*2 : (_placeholderContainerInset.top + _placeholderContainerInset.bottom)]];
}
...
+ (instancetype)textViewWithPlaceholderInset:(UIEdgeInsets)placeholderInset {
    return [[self alloc] initWithPlaceholderInset:placeholderInset];
}
