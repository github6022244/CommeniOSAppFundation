...
#pragma mark - Global Color
    ...
    QMUICMI.disabledColor = UIColorMakeWithHex(@"#CCCCCC");                                        // UIColorDisabled : 全局 disabled 的颜色，一般用于 UIControl 等控件
    QMUICMI.backgroundColor = UIColor.qd_backgroundColor;                                     // UIColorForBackground : 界面背景色，默认用于 QMUICommonViewController.view 的背景色
    QMUICMI.maskDarkColor = UIColorMakeWithRGBA(0, 0, 0, .55f);                 // UIColorMask : 深色的背景遮罩，默认用于 QMAlertController、QMUIDialogViewController 等弹出控件的遮罩
    ...
    // 测试用的颜色
    QMUICMI.testColorRed = UIColorMakeWithHex(@"#F01A1A");
...
#pragma mark - UISwitch
    QMUICMI.switchOnTintColor = UIColorMakeWithHex(@"#033FFF");
//    QMUICMI.switchOnTintColor = UIColor.qd_tintColor;                           // SwitchOnTintColor : UISwitch 打开时的背景色（除了圆点外的其他颜色）
    QMUICMI.switchOffTintColor = UIColorMakeWithHex(@"#F2F2F2");                  // SwitchOffTintColor : UISwitch 关闭时的背景色（除了圆点外的其他颜色）
...
#pragma mark - NavigationBar
    ...
    QMUICMI.navBarButtonFontBold = UIFontBoldMake(14);                          // NavBarButtonFontBold : QMUINavigationButtonTypeBold 的字体
    ...
    QMUICMI.navBarTintColor = UIColor.qd_titleTextColor;                                     // NavBarTintColor : QMUINavigationBar 的 tintColor，也即导航栏上面的按钮颜色
    QMUICMI.navBarTitleColor = UIColor.qd_titleTextColor;                                 // NavBarTitleColor : UINavigationBar 的标题颜色，以及 QMUINavigationTitleView 的默认文字颜色
    QMUICMI.navBarTitleFont = [UIFont fontWithName:@"PingFangSC-Regular" size:18];                               // NavBarTitleFont : UINavigationBar 的标题字体，以及 QMUINavigationTitleView 的默认字体
...
#pragma mark - TabBar
    ...
    QMUICMI.tabBarBackgroundImage = [[UIImage qmui_imageWithColor:UIColorWhite] resizableImageWithCapInsets:UIEdgeInsetsMake(1, 1, 1, 1)];   // TabBarBackgroundImage : UITabBar 的背景图，建议使用 resizableImage，否则在 UITabBar (NavigationController) 的 setBackgroundImage: 里会每次都视为 image 发生了变化（isEqual: 为 NO）
    if (@available(iOS 15.0, *)) {
    ...
    QMUICMI.tabBarItemTitleFont = UIFontMake(10.f);                                          // TabBarItemTitleFont : UITabBarItem 的标题字体
    QMUICMI.tabBarItemTitleColor = UIColor.qd_titleTextColor;             // TabBarItemTitleColor : 未选中的 UITabBarItem 的标题颜色
    QMUICMI.tabBarItemTitleColorSelected = UIColorMakeWithHex(@"#020822");                // TabBarItemTitleColorSelected : 选中的 UITabBarItem 的标题颜色
...
#pragma mark - SearchBar
    ...
    QMUICMI.searchBarTextFieldCornerRadius = 8.0;                               // SearchBarTextFieldCornerRadius : QMUISearchBar 里的文本框的圆角大小，-1 表示圆角大小为输入框高度的一半
    ...
    QMUICMI.searchBarSearchIconImage = UIImageMake(@"navigation_search_1");                                     // SearchBarSearchIconImage : QMUISearchBar 里的放大镜 icon
...
#pragma mark - Plain TableView
    ...
    QMUICMI.tableViewBackgroundColor = UIColorMakeWithHex(@"#F8F8F8");                    // TableViewBackgroundColor : Plain 类型的 QMUITableView 的背景色颜色
    QMUICMI.tableSectionIndexColor = UIColor.qd_titleTextColor;                         // TableSectionIndexColor : 列表右边的字母索引条的文字颜色
    ...
    QMUICMI.tableViewSectionHeaderFont = UIFontBoldMake(15);                                            // TableViewSectionHeaderFont : Plain 类型的 QMUITableView sectionHeader 里的文字字体
    QMUICMI.tableViewSectionFooterFont = UIFontBoldMake(15);                                            // TableViewSectionFooterFont : Plain 类型的 QMUITableView sectionFooter 里的文字字体
    QMUICMI.tableViewSectionHeaderTextColor = UIColor.qd_titleTextColor;                                             // TableViewSectionHeaderTextColor : Plain 类型的 QMUITableView sectionHeader 里的文字颜色
    QMUICMI.tableViewSectionFooterTextColor = UIColor.qd_titleTextColor;                                              // TableViewSectionFooterTextColor : Plain 类型的 QMUITableView sectionFooter 里的文字颜色
    ...
    QMUICMI.tableViewSectionHeaderContentInset = UIEdgeInsetsMake(15, 15, 15, 15);                        // TableViewSectionHeaderContentInset : Plain 类型的 QMUITableView sectionHeader 里的内容的 padding
    QMUICMI.tableViewSectionFooterContentInset = UIEdgeInsetsMake(15, 15, 15, 15);                        // TableViewSectionFooterContentInset : Plain 类型的 QMUITableView sectionFooter 里的内容的 padding
    if (@available(iOS 15, *)) {
...
#pragma mark - Grouped TableView
    ...
    QMUICMI.tableViewSeparatorColor = TableViewSeparatorColor;                                   // TableViewGroupedSeparatorColor : Grouped 类型的 QMUITableView 分隔线颜色
    ...
    QMUICMI.tableViewGroupedCellBackgroundColor = UIColorForBackground;                    // TableViewGroupedCellBackgroundColor : Grouped 类型的 QMUITableView cell 背景色
    ...
    QMUICMI.tableViewGroupedSectionHeaderFont = UIFontMake(15);                                         // TableViewGroupedSectionHeaderFont : Grouped 类型的 QMUITableView sectionHeader 里的文字字体
    QMUICMI.tableViewGroupedSectionFooterFont = UIFontMake(15);                                         // TableViewGroupedSectionFooterFont : Grouped 类型的 QMUITableView sectionFooter 里的文字字体
    QMUICMI.tableViewGroupedSectionHeaderTextColor = UIColor.qd_titleTextColor;                                 // TableViewGroupedSectionHeaderTextColor : Grouped 类型的 QMUITableView sectionHeader 里的文字颜色
    ...
    QMUICMI.tableViewGroupedSectionHeaderDefaultHeight = 45.0;                 // TableViewGroupedSectionHeaderDefaultHeight : Grouped 类型的 QMUITableView sectionHeader 的默认高度（也即没使用自定义的 sectionHeaderView 时的高度），注意如果不需要间距，请用 CGFLOAT_MIN
    QMUICMI.tableViewGroupedSectionFooterDefaultHeight = 45.0;                 // TableViewGroupedSectionFooterDefaultHeight : Grouped 类型的 QMUITableView sectionFooter 的默认高度（也即没使用自定义的 sectionFooterView 时的高度），注意如果不需要间距，请用 CGFLOAT_MIN
...
#pragma mark - QMUIBadge
    ...
    QMUICMI.badgeBackgroundColor = UIColorMakeWithHex(@"#F74A3E");                                  // BadgeBackgroundColor : QMUIBadge 上的未读数的背景色
    QMUICMI.badgeTextColor = UIColorForBackground;                                      // BadgeTextColor : QMUIBadge 上的未读数的文字颜色
    QMUICMI.badgeFont = UIFontMake(12);                                     // BadgeFont : QMUIBadge 上的未读数的字体
    QMUICMI.badgeContentEdgeInsets = UIEdgeInsetsMake(0, 2, 0, 2);              // BadgeContentEdgeInsets : QMUIBadge 上的未读数与圆圈之间的 padding
    ...
    QMUICMI.updatesIndicatorColor = QMUICMI.badgeBackgroundColor;                                 // UpdatesIndicatorColor : QMUIBadge 上的未读红点的颜色
...
- (UIColor *)themeTintColor {
    return UIColorMakeWithHex(@"#3E6AF7");
}

- (UIColor *)themeTitleTextColor {
    return [UIColorBlack colorWithAlphaComponent:0.8];
}

- (UIColor *)themeMainTextColor {
    return [UIColorBlack colorWithAlphaComponent:0.6];
}

- (UIColor *)themeDescriptionTextColor {
    return [UIColorBlack colorWithAlphaComponent:0.4];
}

- (UIColor *)themePlaceholderColor {
    return UIColorMakeWithHex(@"#B2B2B2");
}
...
- (UIColor *)themeSeparatorColor {
    return UIColorMakeWithHex(@"#EEEEEE");
}
