...
@interface UIBaseWebViewController : UIBaseViewController<GGUIBaseViewControllerDebugProtocol>
...
#pragma mark - UIBaseWebViewController (SubclassHooks)
//以下方法供子类调用
@interface UIBaseWebViewController (SubclassHooks)
